...
export default async function AdminPage() {
    ...
    const adminSupabase = createAdminClientIfConfigured()

    let configurationWarning: string | null = null
    let organizations: OrganizationVerificationOverview[] = []

    if (!adminSupabase) {
        configurationWarning = 'Set SUPABASE_SERVICE_ROLE_KEY to enable global admin organization visibility.'
    } else {
        organizations = await listOrganizationsWithVerification(adminSupabase, 100)
    }
